...
The package exposes three top-level functions plus the bundled
dashboard launcher.
...
End users should call `get_enrollment()` / `get_schooling()`. The
datasets are exposed for inspection but the public API normalises
